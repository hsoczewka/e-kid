...
{
    public const string ManageActivityId = "22a0766a-b49c-45a2-8418-9f93e25a6440";
    ...
    public static Permission ManageActivity => new Permission("ManageActivity", Guid.Parse(ManageActivityId));
